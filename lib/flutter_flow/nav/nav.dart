...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => OtpVerificationScreenWidget(
            mobileNumber: params.getParam('mobileNumber', ParamType.int),
          ),
        ),
        FFRoute(
          name: 'home_screen',
        ...
        FFRoute(
          ...
          path: '/categoryScreen',
          builder: (context, params) => const CategoryScreenWidget(),
        ),
        FFRoute(
          name: 'cart_screen',
          path: '/cartScreen',
          builder: (context, params) => const CartScreenWidget(),
        ),
        FFRoute(
          name: 'checkout_screen',
          path: '/checkoutScreen',
          builder: (context, params) => const CheckoutScreenWidget(),
        ),
        FFRoute(
          name: 'product_list_screen',
          path: '/productListScreen',
          builder: (context, params) => const ProductListScreenWidget(),
        ),
        FFRoute(
          name: 'order_placed_screen',
          path: '/orderPlacedScreen',
          builder: (context, params) => const OrderPlacedScreenWidget(),
        ),
        FFRoute(
          name: 'orders_screen',
          path: '/ordersScreen',
          builder: (context, params) => const OrdersScreenWidget(),
        ),
        FFRoute(
