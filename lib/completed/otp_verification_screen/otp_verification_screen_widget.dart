                        ...
                        Builder(
                          builder: (context) => FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.otpVerificationApi = await SpeedcemGroup
                              ...
                              shouldSetState = true;
                              if ((_model.otpVerificationApi?.succeeded ??
                                  true)) {
                                FFAppState().token = SpeedcemGroup
                                    .verifyAuthorizationOTPCall
                                    .authToken(
                                      (_model.otpVerificationApi?.jsonBody ??
                                          ''),
                                    )
                                    .toString();
                                FFAppState().updateUserStruct(
                                  (e) => e
                                    ..uid =
                                        SpeedcemGroup.verifyAuthorizationOTPCall
                                            .authToken(
                                              (_model.otpVerificationApi
                                                      ?.jsonBody ??
                                                  ''),
                                            )
                                            .toString()
                                    ...
                                    return Material(
                                      ...
                                      child: WebViewAware(
                                        ...
                                        child: const SuccessFailureSnackbarWidget(
                                          ...
                                          subTitle:
                                              'Please provide valid One Time Password.',
                                        ),
                                      )),
                                    );
                                  },
